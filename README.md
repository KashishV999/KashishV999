...
![WebSockets](https://img.shields.io/badge/-WebSockets-000000?style=flat-square&logo=websocket&logoColor=white)
...
A multi-modal AI adoption assistant leveraging Retrieval-Augmented Generation (RAG) using OpenAI GPT-3.5 and MongoDB Atlas Vector Search for semantic pet matching. Features secure JWT/OAuth authentication, shelter and user management, real-time analytics dashboards, Reddit-style nested comments, and media handling via Cloudinary. Fully integrated with Stripe for payments and Nodemailer for email notifications. Built with a responsive Tailwind CSS frontend delivering an intuitive user experience.
        </p>
        <p align="center">
